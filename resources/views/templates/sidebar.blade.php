        ...
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="/anggota/buku/daftar"><i class="ti-book"></i><span>Buku</span></a></li>
                    <li><a href="/anggota/pinjaman/riwayat"><i class="ti-bookmark"></i><span>Riwayat Pinjam</span></a>
                    <li><a href="/anggota/peminjaman/daftar"><i class="ti-agenda"></i><span>Form Peminjaman</span></a></li>
                    </li>
                    @endrole
                    @role('pegawai')
