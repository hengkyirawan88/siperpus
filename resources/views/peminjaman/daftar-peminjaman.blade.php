                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="badge badge-success btn-sm m-1" data-toggle="modal"
                                            ...
                                            onclick="pengembalianPinjaman('{{ $peminjaman->idbuku }}','{{ $peminjaman->id }}','{{ $hari_pengembalian }}','{{ $peminjaman->user->name }}','{{ date('Y-m-d') }}')"><i
                                                class="fa fa-undo"></i>
                                            Pengembalian</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/kelola/peminjaman/pengembalian" method="POST">
                    ...
                    <input type="hidden" name="idbuku" value="{{ $peminjaman->idbuku }}" required>
                    <div class="form-group">
...
<script>
    ...
    function detailPeminjaman(id, nama_anggota) {
        ...
        function pengembalianPinjaman(idbuku, id, hari_pengembalian, nama_anggota, today){
