...
<div class="main-content-inner">
    <div class="row">
        <div class="col-lg-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Klik tombol untuk Peminjaman Buku Perpustakaan</h4>
                    @if(session('status'))
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/anggota/peminjaman/tambah" method="POST">
                    @csrf
                    <div class="form-group">
                        ...
                        <select class="select-two form-control" id="nama_buku" name="nama_buku" required
                            ...
                            <option value="{{ $buku['id'] }}">{{ $buku['nama'] . " - " . $buku['pengarang'] }}
                            </option>
                            @endforeach
                        </select>
                        <!-- <input name="id" type="text" value="{{ $buku['id'] }}">   -->
                    </div>
                    <div class="form-group">
