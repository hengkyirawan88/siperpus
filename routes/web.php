...
Route::group(['middleware' => ['auth', 'role:anggota']], function () {
    ...
    Route::get('/anggota/buku/daftar', 'AnggotaController@buku');
    Route::get('/anggota/buku/detail/{slug}', 'AnggotaController@bukudetail');
    Route::get('/anggota/peminjaman/daftar', 'AnggotaController@peminjaman');
    Route::post('/anggota/peminjaman/tambah', 'AnggotaController@tambah');
